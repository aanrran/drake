...
// auto model_instance = parser.AddModelsFromUrl("package://drake_models/atlas/atlas_convex_hull.urdf").at(0);

// Set the initial pose slightly above the ground
const double initial_z_offset = 1;  // Adjust as needed unit(m)
